...
ALTER SEQUENCE public.comets_comet_id_seq OWNED BY public.comets.comet_id;
...
--
-- Name: comets comet_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.comets ALTER COLUMN comet_id SET DEFAULT nextval('public.comets_comet_id_seq'::regclass);
...
INSERT INTO public.star VALUES (1, 'Grover', 12, 32, 'Sesame Street');
INSERT INTO public.star VALUES (2, 'Kermit', 34, 54, 'He is a frog.');
INSERT INTO public.star VALUES (3, 'Oscar', 34, 98, 'Grumpy');
INSERT INTO public.star VALUES (4, 'Fozzie', 48, 23, 'Here for the laughs.');
INSERT INTO public.star VALUES (5, 'Miss Piggy', 24, 24, 'Ron loved her.');
INSERT INTO public.star VALUES (6, 'Swedish Chef', 4, NULL, 'Bork bork!');
